...
namespace Algorithm
{
    ...
    // - Technically, this is not precisely equivalent to the original code. I've made all the properties read-only, turned the default 
    //   constructor private, added another constructor, and provided the Empty method for the trivial case of a pair with no people in
    //   it. Strictly speaking, this makes it more than just refactoring since I'm changing the signature of a class visible outside 
    //   this assembly, but the rules seem to make it fair game. 
    ...
    //   calculate AgeDifference up front. It would be equally easy to keep the setters public and calculate AgeDifference on the fly:
