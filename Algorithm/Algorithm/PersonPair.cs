...
namespace Algorithm
{
    ...
    // - The idea here is that since externally changing any of its properties could put a PersonPair into an invalid state, the class 
    //   should encapsulate their logic and enforce its own validity. 
